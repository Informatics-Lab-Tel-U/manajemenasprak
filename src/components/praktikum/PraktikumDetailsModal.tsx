      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid gap-4 py-2">
            ...
            <div className="space-y-3">
                <h4 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Jadwal Kelas</h4>
                            ...
                            {details.classes.map((cls, idx) => (
                                <div key={idx} className="border rounded-md p-3 bg-card shadow-sm">
                                    <div className="flex justify-between items-center mb-2">
                                        <Badge variant="secondary" className="font-semibold">{cls.kelas}</Badge>
                                    </div>
                                    <div className="space-y-1.5">
                                        {cls.jadwal.map((j, jIdx) => (
                                            <div key={jIdx} className="flex items-center text-sm text-muted-foreground">
