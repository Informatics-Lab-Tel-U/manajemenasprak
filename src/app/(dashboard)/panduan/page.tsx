          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            ...
            <AccordionItem value="praktikum" className="border rounded-lg px-4 bg-card">
              ...
              <AccordionContent className="pt-2 pb-6 px-2 space-y-4">
                <DataTable columns={[
                  { name: 'Nama', type: 'String', rule: 'Wajib', desc: 'Nama lengkap praktikum (contoh: Pemrograman Web).' },
                  { name: 'Tahun Ajaran', type: 'String', rule: 'Wajib', desc: 'Format: YYYY-Sem (Contoh: "2425-1").' },
                ]} />
            ...
            <AccordionItem value="matakuliah" className="border rounded-lg px-4 bg-card">
              ...
              <AccordionContent className="pt-2 pb-6 px-2 space-y-4">
                <DataTable columns={[
                  ...
                  { name: 'Praktikum', type: 'Relation', rule: 'Wajib', desc: 'Mengacu ke Data Praktikum (nama + tahun ajaran).' },
                  { name: 'Program Studi', type: 'String', rule: 'Wajib', desc: 'Contoh: Informatika, Sistem Informasi.' },
                  { name: 'Dosen Koor', type: 'String', rule: 'Opsional', desc: 'Nama dosen koordinator.' },
                ]} />
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="pelanggaran" className="border rounded-lg px-4 bg-card">
              ...
              <AccordionContent className="pt-2 pb-6 px-2 space-y-5">
                ...
                <div>
                  ...
                  <DataTable columns={[
                    { name: 'NIM', type: 'String', rule: '', desc: 'Nomor Induk Mahasiswa asprak.' },
                    { name: 'NAMA', type: 'String', rule: '', desc: 'Nama lengkap asprak.' },
                    { name: 'KODE ASPRAK', type: 'String', rule: '', desc: 'Kode inisial asprak.' },
                    { name: 'MODUL', type: 'Integer', rule: '', desc: 'Nomor modul saat pelanggaran terjadi.' },
                    { name: 'KELAS', type: 'String', rule: '', desc: 'Nama kelas jadwal.' },
                    { name: 'PELANGGARAN', type: 'Enum', rule: '', desc: 'Jenis pelanggaran yang dicatat.' },
                  ]} />
