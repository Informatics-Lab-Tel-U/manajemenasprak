                      ...
                      flatViolations.map((v) => (
                        <TableRow key={v.id} className="hover:bg-muted/50 transition-colors">
                          <TableCell className="text-sm truncate">
                            <div className="font-medium truncate">{v.jadwal?.mata_kuliah?.praktikum?.nama ?? '—'}</div>
                          </TableCell>
                          <TableCell>
                            <span className="font-mono text-xs font-semibold">{v._kode_asprak}</span>
                            <div className="text-xs text-muted-foreground truncate">{v._nama_asprak}</div>
                          </TableCell>
                          <TableCell className="text-center text-sm">{v.jadwal?.kelas ?? '—'}</TableCell>
                          <TableCell>
                          ...
                          <TableCell className="text-center text-sm text-muted-foreground">{v.jadwal?.jam ?? '—'}</TableCell>
                        </TableRow>
                      ))
                    )}
                  </TableBody>
